...
public class SafelineApiApplication {
    ...
    public CommandLineRunner initData(SolutionRepository solutionRepository,
                                      CaseStudyRepository caseStudyRepository) { // CaseStudyRepository 주입
        return args -> {
            // 기존 Solution 데이터
            Solution solution1 = Solution.builder()
                    .categoryTitle("하드웨어 솔루션")
                    .name("SAFELINE M4D")
                    .tagline("세상에서 가장 스마트한 XR 4D 시뮬레이터")
                    .image("/images/solutions/solution_m4d.jpg")
                    .link("safeline-m4d")
                    .build();

            Solution solution2 = Solution.builder()
                    .categoryTitle("소프트웨어 & 플랫폼")
                    .name("Total Management System (TMS)")
                    .tagline("단 한 명의 교육자가 실현하는 완벽한 VR 집체교육")
                    .image("/images/solutions/solution_tms.jpg")
                    .link("tms")
                    .build();
            ...
            CaseStudy case2 = CaseStudy.builder()
                    .slug("komipo")
                    .clientName("한국중부발전")
            ...
            CaseStudy case3 = CaseStudy.builder()
                    .slug("lotte-hrd")
                    .clientName("롯데인재개발원")
